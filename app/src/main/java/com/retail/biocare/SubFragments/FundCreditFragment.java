 ...
 * Use the {@link FundCreditFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FundCreditFragment extends Fragment {
    ...
    FundTransferCreditAdapter fundTransferCreditAdapter;
    TextView txtNotFound;

    public FundCreditFragment() {
    ...
    public static FundCreditFragment newInstance() {
        FundCreditFragment fragment = new FundCreditFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fund_credit, container, false);
            ...
            else if(s.equals("[]"))
            {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        {
                            fundTransferCreditAdapter =new FundTransferCreditAdapter(getContext(),fundTransferHistoryModels,userBasicData.get("Username"));
